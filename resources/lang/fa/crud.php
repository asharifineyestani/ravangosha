...
return [
    ...
    */
    ...
    'menu' => [
        'verify_codes' => 'کدهای تایید',
        'books' => 'کتاب ها',
        'sellers' => 'فروشندگان',
        'top-menu' => 'منوی بالا',
        'images' => 'گالری تصاویر',
        'games' => 'بازی ها',
        'positions' => 'جایگاه بازیکنان',
        'order-items' => 'آیتم سفارش',
        'stocks' => 'انبار',
        'league-teams' => 'جدول لیگ',
        'players' => 'بازیکنان',
        'menu' => 'منو',
        'comments' => 'کامنت ها',
        'courses' => 'دوره ها',
    ...
    'db' => [
        ...
        'guest'=>'مهمان',
        'guest_id'=>'مهمان',
        'event_time'=>'ساعت بازی',
        'host_goal'=>'گل های میزبان',
        'guest_goal'=>'گل های مهمان',
        'link_report'=>'لینک گزارش بازی',
        'link_ticket'=>'لینک خرید بلیط',
