<div class="row">
    <div class="col-12">
        <form action="#" class="subscribe">
            ...
            <h4 class="subscribe__title">عضویت در خبرنامه</h4>
            <p class="subscribe__text">برای عضویت ایمیل خود را وارد نمایید</p>
            <div class="sign__group">
                <input type="text" class="sign__input" placeholder="ایمیل">
            </div>
            <button type="button" class="sign__btn">درخواست عضویت</button>
        </form>
    </div>
</div>
