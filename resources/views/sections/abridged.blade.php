<section class="section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="section__title">کتاب های خلاصه شده</h2>
            </div>

            <div class="col-12">
                <div class="section__carousel-wrap">
                    <div class="section__carousel owl-carousel" id="subscriptions">
                        @foreach($abridged_books as $abridgedBook)
                        <div class="card">
                            <a href="details.html" class="card__cover">
                                <img src="{{$abridgedBook->book_image_url}}" alt="">
                            ...
                            <h3 class="card__title card__title--subs"><a href="details.html">{{$abridgedBook->title}}</a>
                            </h3>
                            <ul class="card__list card__list--subs">
                                <li>{{$abridgedBook->author->name}}</li>
                            </ul>
                        </div>
                            @endforeach
                    </div>
