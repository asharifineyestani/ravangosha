<section class="section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="section__title"><b>روانگشا</b> بر روی یوتیوب</h2>
                <p class="section__text">شما می توانید آخرین اپیزودهای ویدیویی روانگشا را تماشا کنید</p>
            </div>
                ...
                <div class="section__carousel-wrap">
                    <div class="section__interview owl-carousel" id="flixtv">
                        <div class="interview">
                            <a href="interview.html" class="interview__cover">
                                ...
                                <span>
										<svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                             xmlns="../../www.w3.org/2000/svg.html"><path fill-rule="evenodd"
                                                                                          clip-rule="evenodd"
                            ...
                            <h3 class="interview__title"><a href="interview.html">معرفی کتاب ایلان ماسک</a></h3>
                        </div>
                        ...
                        <div class="interview">
                            ...
                            <h3 class="interview__title"><a href="interview.html">معرفی کتاب وقتی نیچه گریست</a></h3>
                        </div>
                        ...
                        <div class="interview">
                            ...
                            <h3 class="interview__title"><a href="interview.html">نقدی بر کتاب چهار اثر فلورانس</a></h3>
                        </div>
