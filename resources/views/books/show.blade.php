...
@section('content')
    <section class="section section--head section--head-fixed section--gradient section--details-bg" style="margin-top: -40px;">
            ...
            <div class="article">
                ...
                <div class="row">
                    <div class="col-12 col-xl-3">
                        <div class="card">
                            <a href="details.html" class="card__cover" style="width: 300px;" >
                        ...
                        <div class="">
                            ...
                            <div ><div class="scroll-content">
                                    <table >
                                        ...
                                        <tr>
                                            <td>
                                                <div class="main__table-text"><span>نویسنده</span></div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">{{$book->author->name}}</div>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td>
                                                <div class="main__table-text"><span>ناشر</span></div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">{{$book->publication}}</div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="main__table-text"><span>مترجم</span></div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">{{$book->translator}}</div>
                                            </td>
                                        </tr>
                        ...
                        <div class="dashbox">
                            ...
                            <div class="dashbox__table-wrap dashbox__table-wrap--1" data-scrollbar="true" tabindex="-1" style="overflow: hidden; outline: none;"><div class="scroll-content">
                                    <table class="main__table main__table--dash">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="main__table-text"><span>تاریخ انتشار</span></div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">{{$book->publish_date}}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="main__table-text"><span>شابک</span></div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">{{$book->isbn}}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="main__table-text"><span>نوع جلد</span></div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">{{$book->cover_type}}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="main__table-text"><span>قطع</span></div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">{{$book->size}}</div>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td>
                                                <div class="main__table-text"><span>تعداد صفحه</span></div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">{{$book->page_count}}</div>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td>
                                                <div class="main__table-text"><span>سری چاپ</span></div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">{{$book->print_number}}</div>
                                            </td>
                                        </tr>
                                ...
                                <div class="tab-pane fade show active" id="tab-1" role="tabpanel">
                                        ...
                                        <li class="comments__item">
                                            ...
                                            <div class="comments__actions">
                                                <div class="comments__rate">
                                                    <button type="button"><svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="../../www.w3.org/2000/svg.html"><path d="M11 7.3273V14.6537" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M14.6667 10.9905H7.33333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M15.6857 1H6.31429C3.04762 1 1 3.31208 1 6.58516V15.4148C1 18.6879 3.0381 21 6.31429 21H15.6857C18.9619 21 21 18.6879 21 15.4148V6.58516C21 3.31208 18.9619 1 15.6857 1Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg> 12</button>

                                                    <button type="button">7 <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="../../www.w3.org/2000/svg.html"><path d="M14.6667 10.9905H7.33333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M15.6857 1H6.31429C3.04762 1 1 3.31208 1 6.58516V15.4148C1 18.6879 3.0381 21 6.31429 21H15.6857C18.9619 21 21 18.6879 21 15.4148V6.58516C21 3.31208 18.9619 1 15.6857 1Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
                                                </div>
                                        ...
                                        <li class="comments__item comments__item--answer">
                                            ...
                                            <div class="comments__actions">
                                                <div class="comments__rate">
                                                    ...
                                                    <button type="button">0 <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="../../www.w3.org/2000/svg.html"><path d="M14.6667 10.9905H7.33333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M15.6857 1H6.31429C3.04762 1 1 3.31208 1 6.58516V15.4148C1 18.6879 3.0381 21 6.31429 21H15.6857C18.9619 21 21 18.6879 21 15.4148V6.58516C21 3.31208 18.9619 1 15.6857 1Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
                                                </div>
                                        ...
                                        <li class="comments__item comments__item--quote">
                                            ...
                                            <div class="comments__actions">
                                                <div class="comments__rate">
                                                    ...
                                                    <button type="button">2 <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="../../www.w3.org/2000/svg.html"><path d="M14.6667 10.9905H7.33333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M15.6857 1H6.31429C3.04762 1 1 3.31208 1 6.58516V15.4148C1 18.6879 3.0381 21 6.31429 21H15.6857C18.9619 21 21 18.6879 21 15.4148V6.58516C21 3.31208 18.9619 1 15.6857 1Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
                                                </div>
                                        ...
                                        <li class="comments__item">
                                            ...
                                            <div class="comments__actions">
                                                <div class="comments__rate">
                                                    ...
                                                    <button type="button">4 <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="../../www.w3.org/2000/svg.html"><path d="M14.6667 10.9905H7.33333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M15.6857 1H6.31429C3.04762 1 1 3.31208 1 6.58516V15.4148C1 18.6879 3.0381 21 6.31429 21H15.6857C18.9619 21 21 18.6879 21 15.4148V6.58516C21 3.31208 18.9619 1 15.6857 1Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
                                                </div>
                                        ...
                                        <li class="comments__item">
                                            ...
                                            <div class="comments__actions">
                                                <div class="comments__rate">
                                                    ...
                                                    <button type="button">17 <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="../../www.w3.org/2000/svg.html"><path d="M14.6667 10.9905H7.33333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M15.6857 1H6.31429C3.04762 1 1 3.31208 1 6.58516V15.4148C1 18.6879 3.0381 21 6.31429 21H15.6857C18.9619 21 21 18.6879 21 15.4148V6.58516C21 3.31208 18.9619 1 15.6857 1Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
                                                </div>
                                    ...
                                    <div class="catalog__paginator-wrap catalog__paginator-wrap--comments">
                                        ...
                                        <ul class="catalog__paginator">
                                            <li>
                                                <a href="#">
                                                    <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="../../www.w3.org/2000/svg.html"><path d="M0.75 5.36475L13.1992 5.36475" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M5.771 10.1271L0.749878 5.36496L5.771 0.602051" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="../../www.w3.org/2000/svg.html"><path d="M13.1992 5.3645L0.75 5.3645" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M8.17822 0.602051L13.1993 5.36417L8.17822 10.1271" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
